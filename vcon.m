...
% -------------------------------------------------------------------------
% polyhedra
% complex(4).bndop(1).indx - not needed?
% complex(4).bndop(2).indx - not needed?
% complex(4).bndop(3).indx - done previous
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
% faces
% complex(3).bndop(1).indx - done previous - not needed?
% complex(3).bndop(2).indx - done previous
% complex(3).bndop(4).indx
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
% edges
% complex(2).bndop(1).indx - done previous
% complex(2).bndop(3).indx
